        ...
        <form
            ...
            onSubmit={e => {
                ...
                const q = (form.querySelector('[name="q"]') as HTMLInputElement)
                    ?.value;
                const ratingMin = (
                    form.querySelector('[name="ratingMin"]') as HTMLInputElement
                )?.value;
                const ratingMax = (
                    form.querySelector('[name="ratingMax"]') as HTMLInputElement
                )?.value;
                const slopeMin = (
                    form.querySelector('[name="slopeMin"]') as HTMLInputElement
                )?.value;
                const slopeMax = (
        ...
        >
            ...
            <div className="flex flex-col gap-1">
                ...
                <Select
                    ...
                    onValueChange={v =>
                        updateParams({ teeType: v === "all" ? undefined : v })
                    }
                >
